...
export default function Layout({ children, params: { slug } }: CollectionsLayoutProps) {
  return (
...
async function CollectionsLayout({ children, params: { slug } }: CollectionsLayoutProps) {
      ...
      <div className='flex flex-col gap-10'>
        {banner && (
          <div className='relative hidden sm:block'>
            <WixImage mediaIdentifier={banner.url} width={1280} height={400} alt={banner.altText} />
  ...
  return (
    <main className='mx-auto max-w-7xl space-y-10 px-5 py-10'>
      ...
      <div className='space-y-5'>
        <h2 className='text2xl font-bold'>Products</h2>
