...
import { CheckIcon, LogInIcon, LogOutIcon, Monitor, Moon, Sun, UserIcon } from 'lucide-react';
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className='min-w-44 max-w-64'>
        {loggedInMember && (
          <>
            <DropdownMenuLabel>
              Logged in as {loggedInMember.contact?.firstName || loggedInMember.loginEmail}
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            <Link href='/profile'>
              <DropdownMenuItem>
