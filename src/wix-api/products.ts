...
export async function queryProducts(
  wixClient: WixClient,
  { collectionIds, sort = 'last_updated', skip, limit, q, priceMax, priceMin }: QueryProductsFilter,
) {
...
// caching because this function is called multiple times in the same request (metadata and page)
